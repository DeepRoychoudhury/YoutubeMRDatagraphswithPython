...
try:
	...
	cursor.execute("SELECT median from stddevmedian where country='IN' AND operationtype='interactive' ")
	stdresult = cursor.fetchall()
	cursor.execute("SELECT median from stddevmedian where country='US' AND operationtype='interactive'")
	stdresult1 = cursor.fetchall()
	cursor.execute("SELECT median from stddevmedian where country='CA' AND operationtype='interactive'")
	stdresult2 = cursor.fetchall()
	cursor.execute("SELECT median from stddevmedian where country='FR' AND operationtype='interactive'")
	stdresult3 = cursor.fetchall()
	cursor.execute("SELECT median from stddevmedian where country='RU' AND operationtype='interactive'")
