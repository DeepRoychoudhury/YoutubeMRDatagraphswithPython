...
try:
	...
	cursor.execute("SELECT standarddeviation from stddevmedian where country='US' AND operationtype='interactive'")
	stdresult1 = cursor.fetchall()
	cursor.execute("SELECT standarddeviation from stddevmedian where country='CA' AND operationtype='interactive'")
	stdresult2 = cursor.fetchall()
	cursor.execute("SELECT standarddeviation from stddevmedian where country='FR' AND operationtype='interactive'")
	stdresult3 = cursor.fetchall()
	cursor.execute("SELECT standarddeviation from stddevmedian where country='RU' AND operationtype='interactive'")
